...
public final class ExternalGitUtils {
	 ...
	 * @param depth  if &lt; 1 then apply no limit if &gte; 1 then specify with the --depth option for a shallow checkout.
	 ...
	 * @param repo
	 * @param depth if &lt; 1 then apply no limit if &gte; then specify with the --depth option for a shallow checkout.
